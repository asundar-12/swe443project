...
public class Offer {
    ...
    public Offer(int offerid, Double negotiatedPrice, int mlsid, int buyerid, int sellerid, Date offerDate, String approvedOrRejectSellerStatus, boolean notRespondedYet, Timestamp approvedOrRejectUpdatedDate) {
    ...
    public Offer(Double negotiatedPrice, int mlsid, int buyerid, int sellerid, Date offerDate, String approvedOrRejectSellerStatus, boolean notRespondedYet, Timestamp approvedOrRejectUpdatedDate) {
        this.negotiatedPrice = negotiatedPrice;
        this.mlsid = mlsid;
        this.buyerid = buyerid;
        this.sellerid = sellerid;
